...
final class RegisterCustomTextFieldView: UIView {
    ...
    private func configureTextField() {
        ...
        textField.textColor = StyleConstants.Colors.TextColor.titleColor
    }
    ...
    private func createFieldView() -> UIView {
        ...
        view.layer.borderWidth = AuthModuleLayoutConstants.fieldViewBorderWidth
        view.layer.borderColor = StyleConstants.Colors.GeneralColors.registerTextFieldBorderColor
