...
final class ProfileDataSource {
    ...
    // collection view cells handlers
    struct Collectionhandlers {
        let actualStories: (ActualStoriesCellViewModel) -> Void
        let addActualStories: (AddActualCellViewModel) -> Void
//        let userPost: () -> Void
    }
    ...
    private var collectionHandlers: Collectionhandlers?
    ...
    func updateSections(with sections: [Sections], buttonsHandlers: UserProfileViewHandlers, collectionHandlers: Collectionhandlers) {
        self.sections = sections
        self.handlers = buttonsHandlers
        self.collectionHandlers = collectionHandlers
